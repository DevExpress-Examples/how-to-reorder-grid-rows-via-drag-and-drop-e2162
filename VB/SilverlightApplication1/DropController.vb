...
Namespace DevExpress.AgDataGrid.Internal
	...
	Public Class DragObject
        ...
        Public Function CreateDragShape() As FrameworkElement Implements IDragableObject.CreateDragShape
            Dim drag As New AgDataGridRow(Me.row_Renamed.Handle, Me.source_Renamed)
            drag.Opacity = 0.85
            drag.Width = Me.row_Renamed.ActualWidth
            drag.Height = Me.row_Renamed.ActualHeight
            If Me.source_Renamed.DataRowTemplate IsNot Nothing Then
                drag.Template = Me.source_Renamed.DataRowTemplate
            End If
            drag.ApplyTemplate()
